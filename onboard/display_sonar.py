...
parser = argparse.ArgumentParser(description='ROV Sonar Display')
parser.add_argument('--window-name', default='ROV Sonar Feed', help='Name of the display window')
parser.add_argument('--fullscreen', action='store_true', help='Run in fullscreen mode')
args = parser.parse_args()

# Subscribe to sonar feed
subs_socks = []
    ...
    while keep_running:
        ...
        for sock in socks:
            ...
            if ret[0] == zmq_topics.topic_sonar:
                ...
                # Get the sonar image (using half resolution for display)
